...
use App\Concerns\HasBackups;
use function Livewire\Volt\{state, layout, uses, mount};

layout('layouts.app');

uses([HasBackups::class]);
...
$breadcrumbItems = [
    ...
    [
        'name' => 'Backups',
        'url' => route('management.tools.backups'),
        'active' => true
    ],
];
...
state(compact('breadcrumbItems', 'pageTitle', 'backups', 'files'))->locked();

mount(function() {
    $this->backups = $this->backupList();
    ...
    <div class="card mt-5">
        <header class=" card-header noborder">
            ...
            <div class="justify-center sm:justify-end flex  gap-3 items-center flex-wrap">
                ...
                <button class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2.5">
                                ...
                                <tr class="border border-slate-100 dark:border-slate-900 relative">
                                    ...
                                    <td class="table-td">
                                        <div class="action-btns space-x-2 flex">
                                            ...
                                            @can('delete backups')
                                            <button id="deleteButton{{$key}}" class="action-btn">
