...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayOfPermissionNames = [
            ...
            ['name' => 'list users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'show admin users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'show super admin users', 'module_name' => 'users', 'level' => 'super-admin', 'removable' => false, 'editable' => false, 'assignable' => false],
            ['name' => 'create users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'create admin users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'create super admin users', 'module_name' => 'users', 'level' => 'super-admin', 'removable' => false, 'editable' => false, 'assignable' => false],
            ['name' => 'edit users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'edit admin users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'edit super admin users', 'module_name' => 'users', 'level' => 'super-admin', 'removable' => false, 'editable' => false, 'assignable' => false],
            ['name' => 'delete users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'delete admin users', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'delete super admin users', 'module_name' => 'users', 'level' => 'super-admin', 'removable' => false, 'editable' => false, 'assignable' => false],
            ['name' => 'assign roles', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ['name' => 'assign admin role', 'module_name' => 'users', 'level' => 'admin', 'removable' => false, 'editable' => true, 'assignable' => false],
            ...
            ['name' => 'show site settings', 'module_name' => 'site settings', 'level' => 'regular', 'removable' => false, 'editable' => true, 'assignable' => true],
            ['name' => 'show logo settings', 'module_name' => 'site settings', 'level' => 'regular', 'removable' => false, 'editable' => true, 'assignable' => true],
            ['name' => 'edit logo settings', 'module_name' => 'site settings', 'level' => 'regular', 'removable' => false, 'editable' => true, 'assignable' => true],
            ['name' => 'show identity settings', 'module_name' => 'site settings', 'level' => 'regular', 'removable' => false, 'editable' => true, 'assignable' => true],
            ['name' => 'edit identity settings', 'module_name' => 'site settings', 'level' => 'regular', 'removable' => false, 'editable' => true, 'assignable' => true],
